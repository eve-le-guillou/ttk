...
///
/// \ingroup vtk
/// \class ttkBlankFilter
/// \author Your Name Here <your.email@address.here>
/// \date The Date Here.
///
/// \brief TTK VTK-filter that wraps the ttk::BlankFilter module.
///
/// This VTK filter uses the ttk::BlankFilter module to compute an averaging of
...
///   - standalone/BlankFilter/main.cpp
///
...
// VTK Module
#include <ttkBlankFilterModule.h>
...
// TTK Base Includes
#include <BlankFilter.h>

class TTKBLANKFILTER_EXPORT ttkBlankFilter
  : public ttkAlgorithm // we inherit from the generic ttkAlgorithm class
  ,
    protected ttk::BlankFilter // and we inherit from the base class
{
private:
  /**
...
public:
   ...
   */
  static ttkBlankFilter *New();
  vtkTypeMacro(ttkBlankFilter, ttkAlgorithm);
